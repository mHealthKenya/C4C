            ...
            <div class="form-group">
              <?php if (($_SESSION['user_level'] == 1)|| ($_SESSION['user_level'] == 2) ){?>
                <div class="col-lg-12">
                    <div class="row">
        <div>
          <h3 class="box-title" style="border-bottom: solid 1px; color: #45A3E3;">Registration by Cadre</h3>
...
<?php if ($_SESSION['user_level'] == 4){?>
  ...
  <?php } ?>
    ...
    function draw_chart (county, sub_county, facility, facility_level, sex, age_group, date_from, date_to, descr1, descr2){
      ...
      $.ajax({
          url: "<?php echo base_url(); ?>home/get_hcwbycadre/",
          type: 'POST',
          dataType: 'JSON',
      ...
      Highcharts.chart('mybarcontainer', {
          ...
          type: 'column'
                  ...
                  title: {
                  text: 'Registration by Cadre' + final_descr + ''
                  },
                  xAxis: {
                  categories: myarray,
                          crosshair: true
                  ...
                  series: [{
                  name: 'Registered Health Workers per Cadre',
                  data: yarray
