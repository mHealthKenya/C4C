...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="z-index: 999;">
            ...
            <li class="active">by Facility</li>
        </ol>
    </section>
            ...
            <div class="form-group">
              <?php if ($_SESSION['user_level'] == 5) {?>
                <div class="col-lg-12">
                    <div class="row">
              <div>
                <h3 class="box-title" style="border-bottom: solid 1px; color: #45A3E3;">Exposures by Facility </h3>
...
$.ajax({
  ...
  <?php } ?>
    ...
    function draw_chart (county, sub_county, facility, cadre, sex, age_group, date_from, date_to, descr1, descr2){
      ...
      $.ajax({
          url: "<?php echo base_url(); ?>home/get_exposuresbyfacility/",
          type: 'POST',
          dataType: 'JSON',
      ...
      Highcharts.chart('mybarcontainer', {
          ...
          type: 'column'
                  ...
                  title: {
                  text: 'Exposures by Facility' + final_descr + ''
                  },
                  xAxis: {
                  categories: myarray,
                          crosshair: true
