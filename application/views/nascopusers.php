                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Adds User</h4>
                                </div>
    ...
    oninput="setCustomValidity('')"> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select class="form-control add_county_id" name="county" id="add_county_id" placeholder="County ">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select class="form-control edit_county" name="county" id="edit_county" placeholder="County ">
                                                    <option value="">Please select : </option>
                                                    <?php foreach ($counties as $county):
                                                        ?>
                                                        <option value="<?php echo $county['id']; ?>"><?php echo $county['name']; ?></option>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.add_user_form').submit(function (event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>home/add_nascop_user",
                data: dataString,
        ...
        function get_user_details() {
            $.ajax({
                type: "GET",
                url: "<?php echo base_url(); ?>home/nascopusers/json",
                dataType: "json",
                async: true,
                crossDomain: true,
