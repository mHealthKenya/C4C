        ...
        <section class="col-lg-12 connectedSortable" style="background-color: white;">
            ...
            <div class="form-group">
                <div class="col-lg-12">
                    <div class="row">
        <div>
          <h3 class="box-title" style="border-bottom: solid 1px; color: #45A3E3;">Registration by County</h3>
...
$.ajax({
    ...
    function draw_chart (facility_level, cadre, sex, age_group, date_from, date_to,descr1, descr2){
      var final_descr;
      ...
      $.ajax({
          url: "<?php echo base_url(); ?>home/get_hcwbycounty/",
          type: 'POST',
          dataType: 'JSON',
      ...
      Highcharts.chart('mybarcontainer', {
          ...
          type: 'column'
                  ...
                  title: {
                  text: 'Registration by County'+ final_descr + ' '
                  },
                  xAxis: {
                  categories: myarray,
                          crosshair: true
