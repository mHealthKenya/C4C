                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            if ($access_level === '1' || $access_level === '2') {
                                ...
                                $view = "/views/c4cdash_7/SummaryPage?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no";  // View URL 
                            }
                            if ($access_level === '3') {
                                $county = $this->session->userdata('county');
                                $embeded_url .= "&County=" . $county;

                                $view = "/views/c4cdash/CountyLevelSummaryPage?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no.$embeded_url";  // View URL  
                            }
                            if ($access_level === '4') {
                                $sub_county = $this->session->userdata('sub_county');
                                $embeded_url .= "&sub_county=" . $sub_county;

                                $view = "/views/c4cdash_0/SubCountyLevelSummaryPage?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no.$embeded_url";  // View URL  
                            }
                            if ($access_level === '5') {
                                $facility = $this->session->userdata('facility');
                                $embeded_url .= "&facility=" . $facility;

                                $view = "/views/c4cdash_1/FacilityLevelSummaryPage?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no.$embeded_url";  // View URL  
                            }
                            if ($access_level === '6') {
                                ...
                                $view = "/views/c4cdash_2/PartnerLevelSummaryPage?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no.$embeded_url";  // View URL 
                            }
...
draw_chart();
    function draw_chart (){
      ...
      Highcharts.chart('container', {
          ...
          title: {
              text: 'HCW Registration vs Exposure Trends'
          },
          subtitle: {
