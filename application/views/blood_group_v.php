    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div id="blood_group_table_div" class="blood_group_table_div">
                    ...
                    <section class="content">
                        <div class="row">
                            <div class="col-xs-12">
                                <button type="button" class="btn btn-default add_blood_group_button" id="add_blood_group_button"><i class="fa fa-plus"></i>Add Blood Group </button>
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody class="blood_group_data" id="blood_group_data">
                                                <?php
                                                $i = 1;
                                                ...
                                                foreach ($blood_groups as $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="hidden" name="hidden_blood_group_id" class="hidden_blood_group_id form-control" id="hidden_blood_group_id" value="<?php echo $value['id']; ?>"/>
                                                            <button class='btn btn-xs btn-default edit_blood_group_btn' data-original-title='Edit Blood Group'><i class='fa fa-pencil'></i></button>
                                                            <button class='btn btn-xs btn-default delete_blood_group_btn' data-original-title='Delete Blood Group'><i class='fa fa-trash-o'></i></button></td>
                ...
                <!--Add Blood Group Start -->

                <!-- Modal -->
                <div id="myModal" class="modal fade add_blood_group_div" role="dialog">
                    <form class="form-horizontal add_blood_group_form" id="add_blood_group_form">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="Blood Group Name" class="col-sm-2 control-label">Blood Group Name : </label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control blood_group_name" name="name" id="blood_group_name" placeholder="Blood Group Name : ">
                                            </div>
                                        </div>
                                        ...
                                        <!-- textarea -->                 
                                        <div class="form-group">
                                            <label for="blood_group_status" class="col-sm-2 control-label">Status</label>
                                            <div class="col-sm-10">
                ...
                <!-- Edit Blood Group Start -->
                <!-- Modal -->
                <div id="myModal" class="modal fade edit_blood_group_div" role="dialog">
                    <form class="form-horizontal edit_blood_group_form" id="edit_blood_group_form">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="Blood Group Name" class="col-sm-2 control-label">Blood Group Name : </label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control edit_blood_group_name" name="name" id="edit_blood_group_name" placeholder="Blood Group Name : ">
                                            </div>
                                        </div>
                                        <input type="hidden" name="id" class="edit_blood_group_id form-control" id="edit_blood_group_id"/>
                ...
                <!-- Delete Blood Group Start -->
                <!-- Modal -->
                <div id="myModal" class="modal fade delete_blood_group_div" role="dialog">
                    <form class="form-horizontal delete_blood_group_form" id="delete_blood_group_form">
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <p>Are you sure you want to delete Blood Group : </p>
                                        </div>
                                        <div class="form-group">

                                            <div class="col-sm-10">
                                                <input type="text" class="form-control delete_blood_group_name" name="name" id="delete_blood_group_name" placeholder="Blood Group Name : ">
                                            </div>
                                        </div>
                                        <input type="hidden" name="id" class="delete_blood_group_id form-control" id="delete_blood_group_id"/>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $(".close_edit_modal").click(function () {
                    $(".blood_group_table_div").show();
                });




                $('.add_blood_group_form').submit(function (event) {
                    dataString = $(".add_blood_group_form").serialize();
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>home/add_blood_group",
                        data: dataString,
                        success: function (data) {
                            if (data === "Fail") {
                                alert("Blood group already exists...");
                            } else {
                                get_blood_group_details();
                            }
                ...
                $('.edit_blood_group_form').submit(function (event) {
                    dataString = $(".edit_blood_group_form").serialize();
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>home/edit_blood_group",
                        data: dataString,
                        success: function (data) {

                            get_blood_group_details();
                            $(".blood_group_table_div").show();
                            $(".edit_blood_group_div").modal('hide');
                        }
                ...
                $('.delete_blood_group_form').submit(function (event) {
                    dataString = $(".delete_blood_group_form").serialize();
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>home/delete_blood_group",
                        data: dataString,
                        success: function (data) {

                            get_blood_group_details();
                            $(".blood_group_table_div").show();
                            $(".delete_blood_group_div").modal('hide');
                        }
                ...
                $(".add_blood_group_button").click(function () {
                    $(".add_blood_group_div").modal('show');
                });
                function get_blood_group_details() {
                    $.ajax({
                        type: "GET",
                        url: "<?php echo base_url(); ?>home/blood_group/json",
                        dataType: "json",
                        async: true,
                        crossDomain: true,
                        success: function (response) {
                            $(".blood_group_data").empty();
                            var no = 1;
                            $.each(response, function (i, item) {

                                var id = item.id;
                                var blood_group_name = item.name;
                                var blood_group_status = item.status;
                                var date_added = item.date_added;
                                var timestamp = item.timestamp;
                                var tr_data = "<tr>\n\
                                            <td>" + no + "</td>\n\
                                            <td>" + blood_group_name + "</td>\n\
                                            <td>" + date_added + "</td>\n\
                                            <td>" + blood_group_status + "</td>\n\
                                            <td><input type='hidden' name='hidden_blood_group_id' id='hidden_blood_group_id' class='hidden_blood_group_id hidden' value=" + id + " />\n\
                                            <button class='btn btn-xs btn-default edit_blood_group_btn' data-original-title='Edit Blood Group'><i class='fa fa-pencil'></i></button>\n\
                                            <button class='btn btn-xs btn-default delete_blood_group_btn' data-original-title='Delete Blood Group'><i class='fa fa-trash-o'></i></button></td>\n\
                                                    </tr>";
                                $(".blood_group_data").append(tr_data);
                                $('.blood_group_table_div').prop('value', 'Processing...');
                ...
                $(document).on('click', ".delete_blood_group_btn", function () {
                    //get data
                    var blood_group_id = $(this).closest('tr').find('input[name="hidden_blood_group_id"]').val();
                    //$(".modal_loading").show();

                    $.ajax({
                        type: "GET",
                        url: "<?php echo base_url(); ?>home/get_blood_group_info/" + blood_group_id,
                        dataType: "json",
                        success: function (response) {



                            $('#delete_blood_group_id').val(response[0].id);
                            $('#delete_blood_group_name').val(response[0].name);
                            $(".delete_blood_group_div").modal('show');
                            $(".blood_group_table_div").hide();
                            $(".modal_loading").hide();
                        }, error: function (data) {
                            $(".modal_loading").hide();
                ...
                $(document).on('click', ".edit_blood_group_btn", function () {
                    //get data
                    var blood_group_id = $(this).closest('tr').find('input[name="hidden_blood_group_id"]').val();
                    //$(".modal_loading").show();
