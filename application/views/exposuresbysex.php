            ...
            <div class="form-group">
              <?php if ($_SESSION['user_level'] == 5){?>
                              <div class="col-lg-12">
                                  <div class="row">
                      <div>
                        <h3 class="box-title" style="border-bottom: solid 1px; color: #45A3E3;">Exposures by Gender</h3>
...
<?php if ($_SESSION['user_level'] == 4){?>
  ...
  <?php } ?>
    ...
    function draw_chart (county, sub_county, facility, facility_level, cadre, age_group, date_from, date_to, descr1, descr2){
      ...
      $.ajax({
          url: "<?php echo base_url(); ?>home/get_exposuresbysex/",
          type: 'POST',
          dataType: 'JSON',
      ...
      Highcharts.chart('piecontainer', {
        ...
        title: {
            text: 'Exposuress by Gender' + final_descr + ' '
        },
        tooltip: {
