                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            if ($access_level === '1' || $access_level === '2') {
                                ...
                                $view = "/views/c4cdash_3/LandingPageDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no";  // View URL 
                            }
                            if ($access_level === '3') {
                                $county = $this->session->userdata('county');
                                $embeded_url .= "&County=" . $county;

                                $view = "/views/c4cdash/CountyLandingPageDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no.$embeded_url";  // View URL  
                            }
                            if ($access_level === '4') {
                                $sub_county = $this->session->userdata('sub_county');
                                $embeded_url .= "&sub_county=" . $sub_county;

                                $view = "/views/c4cdash_0/SubCountyLandingPage?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no.$embeded_url";  // View URL  
                            }
                            if ($access_level === '5') {
                                $facility = $this->session->userdata('facility');
                                $embeded_url .= "&facility=" . $facility;

                                $view = "/views/c4cdash_1/FacilityLandingPage?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no.$embeded_url";  // View URL  
                            }
                            if ($access_level === '6') {
                                $partner = $this->session->userdata('partner_name');
                                $embeded_url .= "&Partner=" . $partner;

                                $view = "/views/c4cdash_2/PartnerLandingPage?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no.$embeded_url";  // View URL 
                            }
