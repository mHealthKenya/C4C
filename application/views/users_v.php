                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                 <input type="text" pattern="[0]\d+" required="" minlength="10" maxlength="10" class="form-control phone_no" name="phone_no" id="edit_phone_no" placeholder="Input as 07XXXXXXXX" oninvalid="this.setCustomValidity('Please enter a valid phone number! ')"
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                function get_user_details() {
                    $.ajax({
                        type: "GET",
                        url: "<?php echo base_url(); ?>home/users/json",
                        dataType: "json",
                        async: true,
                        crossDomain: true,
