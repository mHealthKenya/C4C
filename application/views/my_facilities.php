                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"><?php echo $_SESSION['partner_name'];?> Facilities</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control edit_mobileno" name="mobile" id="edit_mobileno" placeholder="Mobile No : ">
                                </div>
                            </div>
							...
							<div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="email" required="" class="form-control edit_email" name="email" id="add_email" placeholder="Email Address : ">
                                            </div>
                           </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.edit_facility_form').submit(function (event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>home/partner_edit_facility",
                data: dataString,
                success: function (data) {
        ...
        function get_facility_details() {
            $.ajax({
                type: "GET",
                url: "<?php echo base_url(); ?>home/my_facilities/json",
                dataType: "json",
                async: true,
                crossDomain: true,
                success: function (response) {
                    ...
                    $.each(response, function (i, item) {
                        ...
                        var tr_data = "<tr>\n\
                                    <td>" + no + "</td>\n\
                                    <td>" + facility_name + "</td><td>" + mfl  + "</td><td>"  + phone + "</td><td>"  + email + "</td><td>"  + county + "</td>\n\
