                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            if ($access_level === '1' || $access_level === '2') {
                                ...
                                $view = "/views/PEPcascade/PepCascade?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no";  // View URL 
                            }
                            if ($access_level === '3') {
                                $county = $this->session->userdata('county');
                                $embeded_url .= "&County=" . $county;

                                $view = "/views/PEPcascade/CascasdeCountyDash?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no.$embeded_url";  // View URL 
                            }
