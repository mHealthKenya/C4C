                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="county_name" class="col-sm-2 control-label">Facility</label>
                                <div class="col-sm-10">

                                    <select class="form-control add_facility_id" name="facility" id="add_facility_id" placeholder="Facility ">
                                        <option value="">Please select : </option>
                                        <?php foreach ($facilities as $facility):
                                            ?>
                                            <option value="<?php echo $facility['code']; ?>"><?php echo $facility['name']; ?></option>
                                            <?php
                                        endforeach;
                                        ?>
                                    </select>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-control add_facility_id" name="facility" id="add_facility_id" placeholder="Fcaility ">
                                    <option value="">Please select : </option>
                                    <?php foreach ($facilities as $facility):
                                        ?>
                                        <option value="<?php echo $facility['code']; ?>"><?php echo $facility['name']; ?></option>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.add_user_form').submit(function (event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>home/add_sub_county_user",
                data: dataString,
        ...
        function get_user_details() {
            $.ajax({
                type: "GET",
                url: "<?php echo base_url(); ?>home/subcountyusers/json",
                dataType: "json",
                async: true,
                crossDomain: true,
                success: function (response) {
                    ...
                    $.each(response, function (i, item) {
                        ...
                        } else if (item.user_level == '5') {
                            var user_level = "Facility";
                        }
