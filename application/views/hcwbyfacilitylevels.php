...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="z-index: 999;">
            ...
            <li class="active">by Facility Levels</li>
        </ol>
    </section>
            ...
            <div class="form-group">
              <?php if ($_SESSION['user_level'] == 5) {?>
                <div class="col-lg-12">
                    <div class="row">
              <div>
                <h3 class="box-title" style="border-bottom: solid 1px; color: #45A3E3;">Registration by Facility Level</h3>
...
<script>
    $(".filter_dashboard").click(function () {
                  ...
                  if(age_group != ""){
                          selected_age_group = ", Age-Group: " +  $(".filter_age_group option:selected").text() + " ";
                  }



                  var descr1 = "For " + selected_county +" "+ selected_sub_county + "  "+ selected_facility + " "+ selected_cadre + " "+ selected_sex + " "+ selected_age_group +" ";
                  var descr2 = " "+ selected_date_from + " " + selected_date_to + " ";

        draw_chart(county, sub_county, facility, cadre, sex, age_group, date_from, date_to, descr1, descr2);
...
draw_chart(county, sub_county, facility, cadre, sex, age_group, date_from, date_to);
...
$.ajax({
  ...
  <?php } ?>
    ...
    function draw_chart (county, sub_county, facility, cadre, sex, age_group, date_from, date_to, descr1, descr2){
      var final_descr;
      ...
      $.ajax({
          url: "<?php echo base_url(); ?>home/get_hcwbyfacilitylevels/",
          type: 'POST',
          dataType: 'JSON',
          data: {county: county, sub_county: sub_county, facility: facility, cadre: cadre, sex: sex, age_group: age_group, date_from: date_from, date_to: date_to},
          success: function (data) {
      ...
      Highcharts.chart('mybarcontainer', {
          ...
          type: 'column'
                  ...
                  title: {
                  text: 'Registration by Facility Level' + final_descr + ''
                  },
                  xAxis: {
                  categories: myarray,
                          crosshair: true
