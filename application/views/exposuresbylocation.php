            ...
            <div class="form-group">
              <?php if ($_SESSION['user_level'] == 5) {?>
                ...
                <div class="col-lg-12">
                    <div class="row">
              <div>
                 <h3 class="box-title" style="border-bottom: solid 1px; color: #45A3E3;">Exposures by Location</h3>
...
draw_chart(county, sub_county, facility, facility_level, sex, cadre, date_from, date_to);
  ...
  <?php } ?>
    ...
    function draw_chart (county, sub_county, facility, facility_level, sex, cadre, date_from, date_to, descr1, descr2){
      ...
      $.ajax({
          url: "<?php echo base_url(); ?>home/get_exposuresbylocation/",
          type: 'POST',
          dataType: 'JSON',
      ...
      Highcharts.chart('mybarcontainer', {
         ...
         type: 'bar'
                 ...
                 title: {
                 text: 'Exposures by Location' + final_descr +''
                 },
                 xAxis: {
                 categories: myarray,
                         crosshair: true
