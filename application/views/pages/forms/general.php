                                ...
                                <form role="form">
                                    <div class="box-body">
                                        <!-- <div class="form-group">
                                          <label for="exampleInputEmail1">Search By:Cell Phone Number,ID Number Or Donor Number</label>
                                        ...
                                        <div class="form-group">
                                            <label for="GG"></label>
                                            <input type="text" class="form-control" id="donordetails" placeholder="">
                                        </div>
                                ...
                                <form class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="studentnationalid" placeholder="Student National Id">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="sex" class="form-control">se
                                        ...
                                        <!--                     <div class="form-group">
                                                              <label for="cellphonenumber" class="col-sm-2 control-label">Contact Details (Postal Address)</label>
                                                              <div class="col-sm-10">
                                                                <input type="textarea" class="form-control" id="cellphonenumber" placeholder="Cell Phone Number">
                                                              </div>
                                                            </div>-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <textarea class="form-control" rows="3" placeholder="Contact Details (Postal Address)"></textarea>
                                            </div>
                                        </div>
                                        <!--                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="cellphonenumber" class="col-sm-2 control-label">Cell Phone Number</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="cellphonenumber" placeholder="Cell Phone Number">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="homephonenumber" class="col-sm-2 control-label">Home Phone Number</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="homephonenumber" placeholder="Home Phone Number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="calendar" class="form-control" id="calendar" placeholder="Date Of Birth">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="Level Of Educaion" class="form-control">                        
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="othermobilisingpartner" placeholder=
                                                       "Other Mobilisisng Partner">
                                            </div>
                                        </div>  
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox">I hereby give consent to NBTS to send me SMS texts
                                                    </label>
                                                </div>
                                            </div>
