            ...
            <div class="row">
                <div class="col-xs-12"> 
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data"  action="<?php echo site_url('home/eexposures'); ?>">
                            ...
                            <table id="mytables" class="table table-bordered table-striped">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>Mfl code</th>                                       
                                        <th>Date Enrolled</th>
                                        <!-- <th>Hepatits B status</th> -->
                                        <th>Facility</th>
                                        <th>County</th>
                                        <!-- <th>Exposure Type</th>
                                        <th>Exposure Result</th>
                                        <th>Exposure Date</th>
                                        <th>When</th>
                                        <th>Cause</th>
                                        <th>Purpose</th>
                                ...
                                <tbody class="user_data" id="user_data">
                                    ...
                                    foreach ($allexpo as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $value['cadre']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['mfl_no']; ?>
                                            </td>                                          

                                            <td>
                                                <?php echo $value['enrollment_date']; ?>
                                            </td>
                                           <!--  <td>
                                                <?php echo $value['hepatitsb_status']; ?>
                                            </td> -->
                                            ...
                                            <!-- <td>
                                                <?php echo $value['exposure_type']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['exposure_result']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['exposed_date']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['whenithapnd  ']; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <?php echo $value['hivstatus']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['hbvstatus']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['exposuresnumber']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['devicesafety']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['dateofpepinit']; ?>
                                            </td>
 -->
...
//    });
    ...
    j(document).ready(function () {
        j('#mytables').on('processing.dt', function (e, settings, processing) {
