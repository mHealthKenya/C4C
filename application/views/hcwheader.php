...
{?>
                            <li><a href="<?php echo base_url(); ?>home/hcwbysex"><i class="fa fa-list-ol"></i>Sex</a></li>
                            <li><a href="<?php echo base_url(); ?>home/hcwbycadre"><i class="fa fa-hospital-o"></i>Cadre</a></li>
                            <li><a href="<?php echo base_url(); ?>home/hcwbycounty"><i class="fa fa-hospital-o"></i>County</a></li>
                            <li><a href="<?php echo base_url(); ?>home/hcwbyagegroups"><i class="fa fa-hospital-o"></i>Age Groups</a></li>
                            <li><a href="<?php echo base_url(); ?>home/hcwbyfacilitylevels"><i class="fa fa-hospital-o"></i>Facility Levels</a></li>
                ...
                {?>
                  <li><a href="<?php echo base_url(); ?>home/hcwbysex"><i class="fa fa-list-ol"></i>Sex</a></li>
                  <li><a href="<?php echo base_url(); ?>home/hcwbycadre"><i class="fa fa-hospital-o"></i>Cadre</a></li>
                  <li><a href="<?php echo base_url(); ?>home/hcwbysubcounty"><i class="fa fa-hospital-o"></i>Sub-County</a></li>
                  <li><a href="<?php echo base_url(); ?>home/hcwbyagegroups"><i class="fa fa-hospital-o"></i>Age Groups</a></li>
                  <li><a href="<?php echo base_url(); ?>home/hcwbyfacilitylevels"><i class="fa fa-hospital-o"></i>Facility Levels</a></li>
                  <li><a href="<?php echo base_url(); ?>Login/logout"><i class="fa fa-sign-out"></i>Logout </a></li>
