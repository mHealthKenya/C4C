...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="z-index: 999;">
            ...
            <li><a href="<?php echo base_url(); ?>home/">Registrations</a></li>
            <li class="active">by Gender</li>
        </ol>
    </section>
            ...
            <div class="form-group">
              <?php if ($_SESSION['user_level'] == 5){?>
                              <div class="col-lg-12">
                                  <div class="row">
                      <div>
                        <h3 class="box-title" style="border-bottom: solid 1px; color: #45A3E3;">Registration by Gender</h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="box">
                      ...
                      <div id="piecontainer"  style="height: 300px;">
                      </div>
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
                </div><!-- /.col -->
...
<script>
    $(".filter_dashboard").click(function () {
                  ...
                  var descr1 = "For " + selected_county +" "+ selected_sub_county + " "+ selected_facility_level +" "+ selected_facility + " "+ selected_cadre + " "+selected_age_group+ " ";
                  var descr2 = " "+ selected_date_from + " " + selected_date_to + " ";

        draw_chart(county, sub_county, facility, facility_level, cadre, age_group, date_from, date_to, descr1, descr2);
...
draw_chart(county, sub_county, facility, facility_level, cadre, age_group, date_from, date_to);
...
<?php if ($_SESSION['user_level'] == 4){?>
  ...
  <?php } ?>
    ...
    function draw_chart (county, sub_county, facility, facility_level, cadre, age_group, date_from, date_to, descr1, descr2){
      var final_descr;
      ...
      $.ajax({
          url: "<?php echo base_url(); ?>home/get_hcwbysex/",
          type: 'POST',
          dataType: 'JSON',
          data: {county: county, sub_county: sub_county, facility: facility, facility_level: facility_level, cadre: cadre, age_group: age_group, date_from: date_from, date_to: date_to},
          success: function (data) {

                var myarray=[];

          for (var i = 0; i < data.length; i++) {
            var myobjects={name:data[i].gender,y:parseInt(data[i].total)};
      ...
      Highcharts.chart('piecontainer', {
        ...
        title: {
            text: 'Registrations by Gender' + final_descr + ' '
        },
        tooltip: {
