...
<div class="content-wrapper">
    ...
    <div id="county_table_div" class="county_table_div">
        ...
        if ($_SERVER['REMOTE_ADDR'] == "41.215.81.58") {
           ...
           $view = "/views/UPDATEDC4CEXTRACT-0709_2/CadreDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no";  // View URL 

            


            //views/C4CLANDINGPAGE-EXTRACT/AgeDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no
