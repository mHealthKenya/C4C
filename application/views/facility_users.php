...
<div class="content-wrapper">
    ...
    <div id="user_table_div" class="user_table_div">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <button class="btn btn-default add_user_button" id="add_user_button"><i class="fa fa-plus"></i>Add Facility Admin </button>

                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Facility Admin Management</h3>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Add Facility Admin</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="User Name" class="col-sm-2 control-label">Sur Name : </label>
                                <div class="col-sm-10">
                            ...
                            <input type="hidden" name="partner_id_session" value="<?php echo $_SESSION['partner_id']; ?>">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <input type="hidden" class = "edit_partner_id" name="partner_id" value="<?php echo $_SESSION['partner_id']; ?>">
                            ...
                            <!--
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            ...
                                                                            <select class="form-control edit_partner_id" name="partner_id" id="edit_partner_id" placeholder="Partner Name : ">
                                                                                <option value="">Please select : </option>
                            <?php foreach ($partners as $partner):
                                ?>
                                                                                            <option value="<?php echo $partner['id']; ?>"><?php echo $partner['name']; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control edit_facility_id" name="facility_id" id="edit_facility_id" placeholder="Facility Name : ">
                                        <option value="">Please select : </option>
                                        <?php foreach ($facilities as $facility):
                                            ?>
                                            <option value="<?php echo $facility['facility_id']; ?>"><?php echo $facility['facility_name']; ?></option>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.add_user_form').submit(function (event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>home/add_facility_user",
                data: dataString,
        ...
        $('.edit_user_form').submit(function (event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>home/edit_facility_user",
                data: dataString,
                success: function (data) {
        ...
        function get_user_details() {
            $.ajax({
                type: "GET",
                url: "<?php echo base_url(); ?>home/facility_users/json",
                dataType: "json",
                async: true,
                crossDomain: true,
        ...
        $(document).on('click', ".edit_user_btn", function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $(".edit_partner_id").val(response[0].partner_id);
