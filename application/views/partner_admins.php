            ...
            <div class="content-wrapper">
                ...
                <div id="user_table_div" class="user_table_div">
                    ...
                    <section class="content">
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-default add_user_button" id="add_user_button"><i class="fa fa-plus"></i>Add Partner Admin </button>

                                <div class="box">
                                    <div class="box-header">
                                        <h3 class="box-title">Partner Admins Management</h3>
    ...
    oninput="setCustomValidity('')"> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select class="form-control add_partner_id" name="partner_id" id="add_partner_id" placeholder="Partner Name : ">
                    ...
                    <form class="form-horizontal edit_user_form" id="edit_user_form">
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    <h4 class="modal-title">Edit Partner Admin</h4>
                                </div>
                                <div class="modal-body">
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('.add_user_form').submit(function (event) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>home/add_partner_user",
                        data: dataString,
                ...
                function get_user_details() {
                    $.ajax({
                        type: "GET",
                        url: "<?php echo base_url(); ?>home/partner_users/json",
                        dataType: "json",
                        async: true,
                        crossDomain: true,
