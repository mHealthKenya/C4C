                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            if ($access_level === '1' || $access_level === '2') {
                                ...
                                $view = "/views/c4cdash_9/LandingPageDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no";  // View URL 
                            }
                            if ($access_level === '3') {
                                $county = $this->session->userdata('county');
                                $embeded_url .= "&County=" . $county;

                                $view = "/views/c4cdash_11/CountyLandingPageDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no";  // View URL  
                            }
                            if ($access_level === '4') {
                                $sub_county = $this->session->userdata('sub_county');
                                $embeded_url .= "&sub_county=" . $sub_county;

                                $view = "/views/c4cdash_12/SubCountyLandingPageDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no";  // View URL  
                            }
                            if ($access_level === '5') {
                                $facility = $this->session->userdata('facility');
                                $embeded_url .= "&facility=" . $facility;

                                $view = "/views/c4cdash_13/FacilityLandingPageDashboard?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no";  // View URL  
                            }
                            if ($access_level === '6') {
