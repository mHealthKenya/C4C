            ...
            <div class="row">
                <div class="col-xs-12">
                        ...
                        <div class="box-header">
                            <h3 class="box-title">TOT Management</h3>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control edit_lname" name="lastname" id="edit_lname" placeholder="Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control edit_facility_id" name="facility" id="edit_facility" placeholder="Facility ">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.edit_user_form').submit(function (event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>home/edit_tot",
                data: dataString,
                success: function (data) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(response, function (i, item) {
                        ...
                        var id = item.id;
                        var user_mobile = item.PhoneNumber;
